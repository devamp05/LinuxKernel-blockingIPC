...
/* ipc block_send.c */
asmlinkage long sys_pSend(pid_t to, const void __user *sData, unsigned int slen, void __user *rData, unsigned int __user *rlen);
asmlinkage long sys_pReceive(pid_t __user *from, void __user *data, unsigned int __user *len);
asmlinkage long sys_pReply(pid_t senderId, const void __user *data, unsigned int len);
asmlinkage long sys_pMsgWaits(void);
/* CMPT 432/832 CHANGE BY dns682, wde364, 2025, 02, 02*/
