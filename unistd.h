...
#define __NR_pSend 441
__SYSCALL(__NR_pSend, sys_pSend)

#define __NR_pReceive 442
__SYSCALL(__NR_pReceive, sys_pReceive)

#define __NR_pReply 443
__SYSCALL(__NR_pReply, sys_pReply)
    
#define __NR_pMsgWaits 444
__SYSCALL(__NR_pMsgWaits, sys_pMsgWaits)
